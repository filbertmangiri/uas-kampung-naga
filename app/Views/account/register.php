	...
	<form id="registerForm" action="<?= base_url('register'); ?>" method="post" enctype="multipart/form-data">
		...
		<div class="form-group mb-4">
			<div class="form-check form-check-inline">
				<input class="form-check-input" type="radio" name="gender" id="genderMale" value="0" <?= (bool) old('gender') == false ? 'checked' : '' ?>>
				<label class="form-check-label" for="genderMale">Laki-laki</label>
			</div>

			<div class="form-check form-check-inline">
				<input class="form-check-input" type="radio" name="gender" id="genderFemale" value="1" <?= (bool) old('gender') == true ? 'checked' : '' ?>>
		...
		<button type="submit" class="btn btn-primary col-12 mb-5">Daftar</button>
	</form>
</div>
...
<script type="text/javascript">
	...
	$(document).ready(function() {
		...
		$('input[name=email]').blur(() => validation('email', 'The email field must contain a unique value.'))
		$('#registerForm').submit(() => validation('email', 'The email field must contain a unique value.'));

		$('input[name=username]').blur(() => validation('username', 'The username field must contain a unique value.'))
		$('#registerForm').submit(() => validation('username', 'The username field must contain a unique value.'));
