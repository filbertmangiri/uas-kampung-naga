...
<?php else : ?>
	<div class="col-12 col-sm-11 col-md-8 col-lg-6 mx-auto text-center">
		<img src="<?= base_url('assets/img/users/' . $account['profile_picture']); ?>" alt="Foto profil <?= $account['username']; ?>" width="150px" id="profilePicture" class="img-thumbnail" role="button" title="Foto profil <?= $account['username']; ?>" style="border-radius: 50%;">
